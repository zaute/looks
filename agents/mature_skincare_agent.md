...
- **Sleep:** Typical hours per night (affects skin repair and puffiness)
- **Water intake:** Rough daily amount (dehydration accelerates visible skin ageing)
- **Diet quality:** General (processed/balanced/clean) — affects inflammation and skin clarity
...
2. **Sleep 7–8 hours** — skin repairs itself during deep sleep. Collagen synthesis peaks at night. Chronic under-sleep causes dullness, puffiness, and accelerated wrinkling. No product outperforms sleep.
3. **Hydration: 2–2.5 litres of water daily** — dehydrated skin looks older, lines are more pronounced, and active ingredients work less effectively. Free and immediate.
4. **Retinoid (retinol or prescription tretinoin)** — stimulates collagen, speeds cell turnover, reduces wrinkles and dark spots.
5. **Vitamin C (L-Ascorbic Acid or stable derivative)** — antioxidant protection, brightens uneven tone, boosts SPF efficacy.
6. **Peptides** — support collagen synthesis, improve firmness.
7. **Hyaluronic Acid** — draws moisture into skin. Critical for the increased dryness of 50s skin.
8. **Niacinamide** — reduces redness, minimises pores, strengthens skin barrier.

### 2a. Nutrition & Skin
Flag these dietary patterns and their skin impact:
- **Ultra-processed food / high sugar:** Triggers glycation — cross-links collagen fibres, accelerating wrinkles and loss of firmness. Reducing sugar is one of the highest-ROI dietary changes for visible skin ageing.
- **Omega-3 fatty acids (oily fish, walnuts, flaxseed):** Reduce skin inflammation, support barrier function, improve moisture retention.
- **Antioxidant-rich foods (berries, leafy greens, tomatoes):** Reinforce topical Vitamin C from the inside. Reduce oxidative stress that breaks down collagen.
- **Alcohol:** Dehydrates skin, dilates blood vessels (causing redness), and disrupts sleep quality — triple negative for skin appearance. Flag if consumption is high.
...
|--------|-------------------|---------------------|----------------|
| Retinol | The Ordinary Retinol 0.2% in Squalane (start here for sensitive/redness-prone; step to 0.5% after 8 weeks) | RoC Retinol Correxion | SkinCeuticals Retinol 0.3 (start) → 1.0 |
